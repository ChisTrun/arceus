...
func (cq *ConversationQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (cq *ConversationQuery) FirstIDX(ctx context.Context) uint64 {
...
func (cq *ConversationQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (cq *ConversationQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (cq *ConversationQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (cq *ConversationQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (cq *ConversationQuery) ForUpdate(opts ...sql.LockOption) *ConversationQuery {
...
func (cq *ConversationQuery) ForShare(opts ...sql.LockOption) *ConversationQuery {
	if cq.driver.Dialect() == dialect.Postgres {
		cq.Unique(false)
	}
	cq.modifiers = append(cq.modifiers, func(s *sql.Selector) {
...
func (cq *ConversationQuery) Modify(modifiers ...func(s *sql.Selector)) *ConversationSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (cs *ConversationSelect) Modify(modifiers ...func(s *sql.Selector)) *ConversationSelect {
