...
func (cu *ConversationUpdate) SetContext(a arceus.Conversation) *ConversationUpdate {
	cu.mutation.SetContext(a)
	return cu
}

// SetNillableContext sets the "context" field if the given value is not nil.
func (cu *ConversationUpdate) SetNillableContext(a *arceus.Conversation) *ConversationUpdate {
	if a != nil {
		cu.SetContext(*a)
	}
	return cu
...
// SetContext sets the "context" field.
func (cuo *ConversationUpdateOne) SetContext(a arceus.Conversation) *ConversationUpdateOne {
	cuo.mutation.SetContext(a)
	return cuo
}

// SetNillableContext sets the "context" field if the given value is not nil.
func (cuo *ConversationUpdateOne) SetNillableContext(a *arceus.Conversation) *ConversationUpdateOne {
	if a != nil {
		cuo.SetContext(*a)
	}
	return cuo
